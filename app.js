...
(function () {
  ...
  const I18N = {
    de: {
      ...
      ft_beauty_go: "Zur Beauty-Seite →", ft_wws: "Zum Warenwirtschaftssystem", ft_wws_note: "Probephase",
    ...
    en: {
      ...
      ft_beauty_go: "To the Beauty site →", ft_wws: "To the inventory system", ft_wws_note: "Trial",
    ...
    ru: {
      ...
      ft_beauty_go: "На страницу Beauty →", ft_wws: "К складской системе", ft_wws_note: "Тест",
    ...
    es: {
      ...
      ft_beauty_go: "A la página Beauty →", ft_wws: "Al sistema de almacén", ft_wws_note: "Prueba",
